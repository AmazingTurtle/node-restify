 ...
 * @instance
 * @function cache
 * @param    {String} [type="public"] value of the header (public|private)
 ...
 * multiple values, so calling `header()` twice for those headers will 
 ...
 * @param {Boolean} [options.overrideQuery] if true, `options.query` stomps over any
